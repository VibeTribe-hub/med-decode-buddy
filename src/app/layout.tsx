...
export const metadata: Metadata = {
  title: 'MediClear',
  description: 'AI-powered medical document analysis that translates complex medical terminology into clear, understandable language for better health decisions.',
};
